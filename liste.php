<?php
    ...
    if($errors->check($session->check(),32768))
    {
        ...
        $footer->submit('', 'Imprimer', ['title'=>'Imprimer les courriers sélectionnés.', 'class'=>'button', 'formaction'=>'pdf.php?cmd=imprimer']);
        $footer->submit('', 'Télécharger', ['title'=>'Télécharger les courriers sélectionnés.', 'class'=>'button','formaction'=>'pdf.php?cmd=telecharger']);
